 ...
 */
@TeleOp(name="IMU Control Heading", group="8610 trials")
// @Disabled
public class IMUControlHeading extends SynchronousOpMode
{
    ...
    @Override public void main() throws InterruptedException
    {
        ...
        while ( opModeIsActive() ){
            //for ( i = 0 ; i < 4 ; i++ ) {
                ...
                //targetAngle = targetHeading + (i * 90);
             currentTime = elapsed.time() * 1000.0;
             if ( currentTime - startTime < 2000){
                    angles = imu.getAngularOrientation();
                    currentAngle = angles.heading;
                    theta = (targetAngle - currentAngle) % 360;
                    rightPower = forwardPower + theta * P;
                    leftPower = forwardPower - theta * P;
                    ...
                    targetAngle = (targetHeading + (i * 90))% 360 ;
                }
               idle();
            //}
        }
